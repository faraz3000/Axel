            ...
            <form action="#" method="post" class="form log-book-form">
                ...
                <div class="rows clr">
                    <div class="column">
                        ...
                        <%= Html.DropDownList("CAR_SEQ_ID", ViewData["CarList"] as SelectList, "", new { @class="text_field",@style="height:40px;", @required="required" })%>
                    </div>
                </div>
                ...
                <div class="back" style="float: right; padding-right: 38px;">
                    <a href="<%= Url.Action("Book_App_Location", "Appointment", new { ID = Model.SEQ_ID })%>" onclick="return GoBack();">Back to Previous Page</a>

                    <input type="submit" class="button small_margin cgreen" value="Save and Calculate Fare" name="savenew" />
